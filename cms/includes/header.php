		...
		<div id="sidebar">
			<ul class="main-nav">
				...
				<li class="<?php echo ($menu == "cursos" ? "active" : "")?>"><a href="cursos.php"><i class="fa fa-cube"></i> Cursos</a></li>

				<li class="<?php echo ($menu == "pedidos" ? "active" : "")?>"><a href="pedidos.php"><i class="fa fa-shopping-cart"></i> Pedidos</a></li>

				<li class="<?php echo ($menu == "clientes" ? "active" : "")?>"><a href="clientes.php"><i class="fa fa-users"></i> Clientes</a></li>

				<li class="<?php echo ($menu == "contacto" ? "active" : "")?>"><a href="contacto.php"><i class="fa fa-address-card-o"></i> Contacto</a></li>

				<li class="<?php echo ($menu == "enlaces" ? "active" : "")?>"><a href="enlaces.php"><i class="fa fa-link"></i> Enlaces</a></li>
