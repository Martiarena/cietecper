...
do{
	$xProducto = $filaCar['cod_curso'];
	$pmostrar = $filaCar['precio_normal'];
	$xCantidad = $filaCar['cantidad'];
	
	//proceso grabar a detalle pedidos
	$pedidoDetalle="INSERT INTO pedidodetalle(cod_orden, cod_curso, precio, cantidad)VALUE('$xOrden', '$xProducto', '$pmostrar', '$xCantidad')";
